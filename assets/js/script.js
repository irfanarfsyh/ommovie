'use strict';
const API_KEY = 'api_key=a15bb2a4b8a774ac4e5028b0340a1fc5';
...
function truncate(str, n, integer) {
...
fetch(requests.fetchTrending)
  ...
  .then((data) => {
    ...
    banner.style.backgroundImage = "url(" + IMG_URL + setMovie.poster_path + ")";
    banner__desc.innerText = truncate(setMovie.overview);
    banner_title.innerText = setMovie.title;
    rating.innerText = setMovie.vote_average;
    release.innerText = setMovie.release_date;
